...
const d = computed(() => `M150 100 C${cx1.value} ${cy1.value} ${cx2.value} ${cy2.value} 350 100`)
const d1 = computed(() => `M${cx1.value} ${cy1.value} L150 100`)
const d2 = computed(() => `M${cx2.value} ${cy2.value} L350 100`)
